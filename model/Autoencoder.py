...
class DoubleConv3DBlock(nn.Module):
    """Conv3D + LeakyReLU(negative_slope=0.1) + Conv3D + LeakyReLU(negative_slope=0.1)"""
    def __init__(self, channel_in: int, channel_out: int) -> None:
...
class Autoencoder_Maxpool(nn.Module):
    ...
    Max-pooling is served as the downsampling method and the
    ...
    def __init__(self) -> None:
        ...
        super(Autoencoder_Maxpool, self).__init__()
...
class Autoencoder_Conv(nn.Module):
    ...
    and the 'trilinear interpolation + convolution' is used
    as the upsampling method. The global residual learning
    is also applied.
    """
    def __init__(self) -> None:
        """Initialises Autoencoder_Maxpool."""
